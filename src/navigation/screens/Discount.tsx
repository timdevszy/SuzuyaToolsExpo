		...
		<View style={styles.container}>
			<View style={styles.emptyState}>
				...
				<Text style={styles.emptyStateSubtitle}>
					Kelola printer, diskon, dan pemindaian produk dari menu di bawah.
				</Text>
				<View style={styles.summaryCard}>
					<Text style={styles.summaryLabel}>Diskon Aktif</Text>
					<Text style={styles.summaryValue}>{activeDiscountPercent}%</Text>
					{activeDescription ? (
						<Text style={styles.summaryDescription}>{activeDescription}</Text>
					) : (
						<Text style={styles.summaryPlaceholder}>Belum ada keterangan</Text>
					)}
				</View>
			</View>
