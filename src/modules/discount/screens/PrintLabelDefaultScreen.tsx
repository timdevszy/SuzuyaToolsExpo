...
export type PrintLabelDefaultRouteParams = {
  scan: ScannedProductData;
};

export function PrintLabelDefaultScreen() {
  const route = useRoute();
  const navigation = useNavigation<any>();
  const viewShotRef = useRef<ViewShot | null>(null);
  const { scan } = route.params as PrintLabelDefaultRouteParams;

  const payload = buildPrintLabelPayload(scan) as PrintLabelPreviewPayload;
    ...
    <View style={styles.screen}>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.card}>
          <Text style={styles.title}>Preview Label Diskon (Default)</Text>
